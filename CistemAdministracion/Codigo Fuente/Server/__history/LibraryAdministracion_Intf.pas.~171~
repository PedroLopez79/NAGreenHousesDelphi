unit LibraryAdministracion_Intf;
...
const
  ...
  IServiceAdministracion_IID : TGUID = '{762597B5-7713-4971-8C5A-32F68BB623AB}';

  { Event ID's }

type
  { Forward declarations }
  IServiceAdministracion = interface;
  ...
  { IServiceAdministracion }
  IServiceAdministracion = interface(IDataAbstractService)
  ...
  CoServiceAdministracion = class
    class function Create(const aMessage: IROMessage; aTransportChannel: IROTransportChannel): IServiceAdministracion;
  end;

  { TServiceAdministracion_Proxy }
  TServiceAdministracion_Proxy = class(TDataAbstractService_Proxy, IServiceAdministracion)
  protected
...
var lSource: LibraryAdministracion_Intf.TParametros;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TParametros) then begin
    lSource := LibraryAdministracion_Intf.TParametros(iSource);
...
var lSource: LibraryAdministracion_Intf.TFactura;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TFactura) then begin
    lSource := LibraryAdministracion_Intf.TFactura(iSource);
    Serie := lSource.Serie;
    Fecha := lSource.Fecha;
...
var lSource: LibraryAdministracion_Intf.TDetalleFactura;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDetalleFactura) then begin
    lSource := LibraryAdministracion_Intf.TDetalleFactura(iSource);
...
var lSource: LibraryAdministracion_Intf.TTicketFactura;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TTicketFactura) then begin
    lSource := LibraryAdministracion_Intf.TTicketFactura(iSource);
...
var lSource: LibraryAdministracion_Intf.TDetalleCupon;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDetalleCupon) then begin
    lSource := LibraryAdministracion_Intf.TDetalleCupon(iSource);
...
var lSource: LibraryAdministracion_Intf.TDetalleValeCreditoFactura;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDetalleValeCreditoFactura) then begin
    lSource := LibraryAdministracion_Intf.TDetalleValeCreditoFactura(iSource);
...
var lSource: LibraryAdministracion_Intf.TDatosFactura;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDatosFactura) then begin
    lSource := LibraryAdministracion_Intf.TDatosFactura(iSource);
...
var lSource: LibraryAdministracion_Intf.TLiquidacion;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TLiquidacion) then begin
    lSource := LibraryAdministracion_Intf.TLiquidacion(iSource);
...
var lSource: LibraryAdministracion_Intf.TLiquidacionDetalle;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TLiquidacionDetalle) then begin
    lSource := LibraryAdministracion_Intf.TLiquidacionDetalle(iSource);
...
var lSource: LibraryAdministracion_Intf.TLiquidacionProducto;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TLiquidacionProducto) then begin
    lSource := LibraryAdministracion_Intf.TLiquidacionProducto(iSource);
...
var lSource: LibraryAdministracion_Intf.TTransaccion;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TTransaccion) then begin
    lSource := LibraryAdministracion_Intf.TTransaccion(iSource);
...
var lSource: LibraryAdministracion_Intf.TDetalleTransaccion;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDetalleTransaccion) then begin
    lSource := LibraryAdministracion_Intf.TDetalleTransaccion(iSource);
...
var lSource: LibraryAdministracion_Intf.TCarteraVale;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TCarteraVale) then begin
    lSource := LibraryAdministracion_Intf.TCarteraVale(iSource);
    CarteraValeCreditoID := lSource.CarteraValeCreditoID;
    NoVale := lSource.NoVale;
    Ticket := lSource.Ticket;
    Importe := lSource.Importe;
...
var lSource: LibraryAdministracion_Intf.TDatosLiquidacion;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDatosLiquidacion) then begin
    lSource := LibraryAdministracion_Intf.TDatosLiquidacion(iSource);
...
var lSource: LibraryAdministracion_Intf.TReporte;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TReporte) then begin
    lSource := LibraryAdministracion_Intf.TReporte(iSource);
    SQL1 := lSource.SQL1;
    SQL2 := lSource.SQL2;
...
var lSource: LibraryAdministracion_Intf.TRecibo;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TRecibo) then begin
    lSource := LibraryAdministracion_Intf.TRecibo(iSource);
    Serie := lSource.Serie;
    Folio := lSource.Folio;
    Fecha := lSource.Fecha;
    Subtotal := lSource.Subtotal;
...
var lSource: LibraryAdministracion_Intf.TDetalleReciboPago;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDetalleReciboPago) then begin
    lSource := LibraryAdministracion_Intf.TDetalleReciboPago(iSource);
    FacturaID := lSource.FacturaID;
    Total := lSource.Total;
...
var lSource: LibraryAdministracion_Intf.TDatosReciboPago;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDatosReciboPago) then begin
    lSource := LibraryAdministracion_Intf.TDatosReciboPago(iSource);
...
var lSource: LibraryAdministracion_Intf.TDatosRecibo;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDatosRecibo) then begin
    lSource := LibraryAdministracion_Intf.TDatosRecibo(iSource);
    Recibo.Assign(lSource.Recibo);
    Detalles.Assign(lSource.Detalles);
  end;
end;
...
var lSource: LibraryAdministracion_Intf.TLoginInfo;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TLoginInfo) then begin
    lSource := LibraryAdministracion_Intf.TLoginInfo(iSource);
...
var lSource: LibraryAdministracion_Intf.TOpcion;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TOpcion) then begin
    lSource := LibraryAdministracion_Intf.TOpcion(iSource);
...
var lSource: LibraryAdministracion_Intf.TConsumoExpress;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TConsumoExpress) then begin
    lSource := LibraryAdministracion_Intf.TConsumoExpress(iSource);
    Secuencia := lSource.Secuencia;
    EstacionID := lSource.EstacionID;
    ClienteID := lSource.ClienteID;
    Precio := lSource.Precio;
...
var lSource: LibraryAdministracion_Intf.TDatosCliente;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDatosCliente) then begin
    lSource := LibraryAdministracion_Intf.TDatosCliente(iSource);
    ClienteID := lSource.ClienteID;
    Nombre := lSource.Nombre;
    RFC := lSource.RFC;
...
var lSource: LibraryAdministracion_Intf.TFacturaExpress;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TFacturaExpress) then begin
    lSource := LibraryAdministracion_Intf.TFacturaExpress(iSource);
    FacturaID := lSource.FacturaID;
    Serie := lSource.Serie;
    Folio := lSource.Folio;
    Fecha := lSource.Fecha;
...
var lSource: LibraryAdministracion_Intf.TDetalleExpress;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDetalleExpress) then begin
    lSource := LibraryAdministracion_Intf.TDetalleExpress(iSource);
    Codigo := lSource.Codigo;
    Descripcion := lSource.Descripcion;
    Cantidad := lSource.Cantidad;
    Precio := lSource.Precio;
...
var lSource: LibraryAdministracion_Intf.TValoresTurno;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TValoresTurno) then begin
    lSource := LibraryAdministracion_Intf.TValoresTurno(iSource);
    Fecha := lSource.Fecha;
    Venta := lSource.Venta;
...
var lSource: LibraryAdministracion_Intf.TOtroProducto;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TOtroProducto) then begin
    lSource := LibraryAdministracion_Intf.TOtroProducto(iSource);
    ID := lSource.ID;
    Nombre := lSource.Nombre;
    Codigo := lSource.Codigo;
...
var lSource: LibraryAdministracion_Intf.TAgrupacion;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TAgrupacion) then begin
    lSource := LibraryAdministracion_Intf.TAgrupacion(iSource);
    AgrupacionID := lSource.AgrupacionID;
...
var lSource: LibraryAdministracion_Intf.TSagarpa;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TSagarpa) then begin
    lSource := LibraryAdministracion_Intf.TSagarpa(iSource);
...
var lSource: LibraryAdministracion_Intf.TDatosPuntos;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDatosPuntos) then begin
    lSource := LibraryAdministracion_Intf.TDatosPuntos(iSource);
    ClienteID := lSource.ClienteID;
...
var lSource: LibraryAdministracion_Intf.TDatosCelular;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDatosCelular) then begin
    lSource := LibraryAdministracion_Intf.TDatosCelular(iSource);
    Telefono := lSource.Telefono;
...
var lSource: LibraryAdministracion_Intf.TEntregaPremio;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TEntregaPremio) then begin
    lSource := LibraryAdministracion_Intf.TEntregaPremio(iSource);
    ClienteID := lSource.ClienteID;
...
var lSource: LibraryAdministracion_Intf.TDatosPremio;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDatosPremio) then begin
    lSource := LibraryAdministracion_Intf.TDatosPremio(iSource);
...
var lSource: LibraryAdministracion_Intf.TConfirmaEnvioA;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TConfirmaEnvioA) then begin
    lSource := LibraryAdministracion_Intf.TConfirmaEnvioA(iSource);
...
var lSource: LibraryAdministracion_Intf.TDatosCerrarLiquidacion;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDatosCerrarLiquidacion) then begin
    lSource := LibraryAdministracion_Intf.TDatosCerrarLiquidacion(iSource);
    LiquidacionID := lSource.LiquidacionID;
    VentasTotales := lSource.VentasTotales;
...
var lSource: LibraryAdministracion_Intf.TDespachadorLiquidacion;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDespachadorLiquidacion) then begin
    lSource := LibraryAdministracion_Intf.TDespachadorLiquidacion(iSource);
...
var lSource: LibraryAdministracion_Intf.TDetalleLiquidacion;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDetalleLiquidacion) then begin
    lSource := LibraryAdministracion_Intf.TDetalleLiquidacion(iSource);
    Cantidad := lSource.Cantidad;
    Importe := lSource.Importe;
    Referencia := lSource.Referencia;
    Ticket := lSource.Ticket;
...
var lSource: LibraryAdministracion_Intf.TTipoValor;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TTipoValor) then begin
    lSource := LibraryAdministracion_Intf.TTipoValor(iSource);
    TipoValorID := lSource.TipoValorID;
    Nombre := lSource.Nombre;
    Grupo := lSource.Grupo;
  end;
...
var lSource: LibraryAdministracion_Intf.TPerfilPuntos;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TPerfilPuntos) then begin
    lSource := LibraryAdministracion_Intf.TPerfilPuntos(iSource);
    FechaIni := lSource.FechaIni;
    FechaFin := lSource.FechaFin;
...
var lSource: LibraryAdministracion_Intf.TFacturaElectronica;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TFacturaElectronica) then begin
    lSource := LibraryAdministracion_Intf.TFacturaElectronica(iSource);
    Serie := lSource.Serie;
    Folio := lSource.Folio;
    Fecha := lSource.Fecha;
...
var lSource: LibraryAdministracion_Intf.TFacturaElectronicaDetalleImportes;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TFacturaElectronicaDetalleImportes) then begin
    lSource := LibraryAdministracion_Intf.TFacturaElectronicaDetalleImportes(iSource);
...
var lSource: LibraryAdministracion_Intf.TFacturaElectronicaDetalleImpuestos;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TFacturaElectronicaDetalleImpuestos) then begin
    lSource := LibraryAdministracion_Intf.TFacturaElectronicaDetalleImpuestos(iSource);
...
var lSource: LibraryAdministracion_Intf.TDatosFacturaPemex;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDatosFacturaPemex) then begin
    lSource := LibraryAdministracion_Intf.TDatosFacturaPemex(iSource);
    TurnoID := lSource.TurnoID;
    EstacionID := lSource.EstacionID;
    Fecha := lSource.Fecha;
    Nombre := lSource.Nombre;
...
var lSource: LibraryAdministracion_Intf.TDetalleFacturaPemex;
begin
  inherited Assign(iSource);
  if (iSource is LibraryAdministracion_Intf.TDetalleFacturaPemex) then begin
    lSource := LibraryAdministracion_Intf.TDetalleFacturaPemex(iSource);
    FacturaPemexID := lSource.FacturaPemexID;
...
class function CoServiceAdministracion.Create(const aMessage: IROMessage; aTransportChannel: IROTransportChannel): IServiceAdministracion;
begin
  result := TServiceAdministracion_Proxy.Create(aMessage, aTransportChannel);
end;

{ TServiceAdministracion_Proxy }

function TServiceAdministracion_Proxy.__GetInterfaceName:string;
begin
  result := 'ServiceAdministracion';
end;

function TServiceAdministracion_Proxy.AbreDataSetReporte(const SQL: AnsiString; const Parametros: TParametros): Binary;
begin
  try
    result := nil;
    ...
    __Message.Write('Parametros', TypeInfo(LibraryAdministracion_Intf.TParametros), Parametros, []);
    __Message.Finalize;
...
procedure TServiceAdministracion_Proxy.ActualizaCupon(const Barras: AnsiString; const DiaConsumo: Integer; const EjercicioConsumo: Integer; const FechaConsumo: DateTime; 
                                                      const PeriodoConsumo: Integer; const Secuencia: Integer; const Ticket: Integer; const Liquidacion: Integer);
begin
  try
...
procedure TServiceAdministracion_Proxy.ActualizaCuponConReferencia(const Barras: AnsiString; const DiaConsumo: Integer; const EjercicioConsumo: Integer; const FechaConsumo: DateTime; 
                                                                   const PeriodoConsumo: Integer; const Secuencia: Integer; const Ticket: Integer; const Referencia: AnsiString);
begin
  try
...
procedure TServiceAdministracion_Proxy.ActualizaLiquidacionCorte(const Liquidacion: Integer; const Secuencia: Integer; const AgrupacionID: Integer);
begin
  try
...
procedure TServiceAdministracion_Proxy.ActualizarStatusValeCredito(const CarteraValeCreditoID: Integer; const Status: AnsiString; const FacturaID: Integer);
begin
  try
...
procedure TServiceAdministracion_Proxy.ActualizaStatusCupon(const Barras: AnsiString; const DiaConsumo: Integer; const EjercicioConsumo: Integer; const FechaConsumo: DateTime; 
                                                            const LiquidacionID: Integer; const PeriodoConsumo: Integer; const Secuencia: Integer);
begin
  try
...
function TServiceAdministracion_Proxy.GeneraFactura(const EstacionID: Integer; const Serie: AnsiString; const FechaCorte: DateTime; const ClienteID: Integer; 
                                                    const UsuarioID: Integer): Integer;
begin
  try
...
function TServiceAdministracion_Proxy.BuscaReporte(const Nombre: AnsiString; const TipoTemplate: Integer): TReporte;
begin
  try
    result := nil;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.TReporte), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
function TServiceAdministracion_Proxy.CambiaFolioFactura(const Serie: AnsiString; const Folio: Integer; const NewSerie: AnsiString; const NewFolio: Integer): AnsiString;
begin
  try
...
function TServiceAdministracion_Proxy.CancelaFactura(const Folio: Integer; const Serie: AnsiString; const Fecha: DateTime; const EstacionID: Integer; const UsuarioID: Integer): AnsiString;
begin
  try
...
function TServiceAdministracion_Proxy.CierraLiquidacion(const LiquidacionID: Integer): AnsiString;
begin
  try
...
function TServiceAdministracion_Proxy.CostoProducto(const ProductoID: Integer): Double;
begin
  try
...
function TServiceAdministracion_Proxy.DatosCliente(const ClienteID: Integer; const Referencia: AnsiString): TDatosCliente;
begin
  try
    result := nil;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.TDatosCliente), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
function TServiceAdministracion_Proxy.Existencia(const EstacionID: Integer; const AlmacenID: Integer; const ProductoID: Integer; const Fecha: DateTime): Double;
begin
  try
...
function TServiceAdministracion_Proxy.FacturaExpress(const Serie: AnsiString; const Folio: Integer): TFacturaExpress;
begin
  try
    result := nil;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.TFacturaExpress), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
function TServiceAdministracion_Proxy.FacturaID(const Serie: AnsiString; const Folio: Integer): Integer;
begin
  try
...
function TServiceAdministracion_Proxy.FacturaYLiquidacion(const ClienteID: Integer): Boolean;
begin
  try
...
function TServiceAdministracion_Proxy.Fecha: DateTime;
begin
  try
...
function TServiceAdministracion_Proxy.Folio(const Campo: AnsiString; const Serie: AnsiString): Integer;
begin
  try
...
function TServiceAdministracion_Proxy.FolioActual(const Campo: AnsiString; const Serie: AnsiString): Integer;
begin
  try
...
function TServiceAdministracion_Proxy.FolioActual2(const Campo: AnsiString; const Serie: AnsiString; const EstacionID: Integer): Integer;
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'FolioActual2');
    __Message.Write('Campo', TypeInfo(AnsiString), Campo, []);
    __Message.Write('Serie', TypeInfo(AnsiString), Serie, []);
    __Message.Write('EstacionID', TypeInfo(Integer), EstacionID, []);
    __Message.Finalize;
...
procedure TServiceAdministracion_Proxy.GuardaAccesos(const UsuarioID: Integer; const Lista: AnsiString);
begin
  try
...
function TServiceAdministracion_Proxy.GuardaConsumoExpress(const Consumo: TConsumoExpress): Boolean;
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'GuardaConsumoExpress');
    __Message.Write('Consumo', TypeInfo(LibraryAdministracion_Intf.TConsumoExpress), Consumo, []);
    __Message.Finalize;
...
procedure TServiceAdministracion_Proxy.GuardaLimiteFactura(const UsuarioID: Int64; const Cantidad: Double);
begin
  try
...
procedure TServiceAdministracion_Proxy.GuardarDatosFactura(const DatosFactura: TDatosFactura);
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'GuardarDatosFactura');
    __Message.Write('DatosFactura', TypeInfo(LibraryAdministracion_Intf.TDatosFactura), DatosFactura, []);
    __Message.Finalize;
...
procedure TServiceAdministracion_Proxy.GuardarDatosLiquidacion(const DatosLiquidacion: TDatosLiquidacion);
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'GuardarDatosLiquidacion');
    __Message.Write('DatosLiquidacion', TypeInfo(LibraryAdministracion_Intf.TDatosLiquidacion), DatosLiquidacion, []);
    __Message.Finalize;
...
procedure TServiceAdministracion_Proxy.GuardarDatosReciboPago(const DatosReciboPago: TDatosReciboPago);
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'GuardarDatosReciboPago');
    __Message.Write('DatosReciboPago', TypeInfo(LibraryAdministracion_Intf.TDatosReciboPago), DatosReciboPago, []);
    __Message.Finalize;
...
function TServiceAdministracion_Proxy.GuardarFacturaExpress(const ClienteID: Integer; const Serie: AnsiString; const EstacionID: Integer; const TicketID: Integer): TFacturaExpress;
begin
  try
    result := nil;
...
procedure TServiceAdministracion_Proxy.InsertaDeposito(const DepositoID: Integer; const Cantidad: Double; const Usuario: Integer; const Fecha: DateTime; const Secuencia: Integer; 
                                                       const EstacionID: Integer; const Descripcion: AnsiString; const Ejercicio: Integer; const Periodo: Integer; 
                                                       const Dia: Integer);
begin
  try
...
procedure TServiceAdministracion_Proxy.InsertaProductoPrecio(const ProductoID: Integer; const EstacionID: Integer; const Precio: Double);
begin
  try
...
function TServiceAdministracion_Proxy.Login(const Usuario: AnsiString; const Clave: AnsiString): TLoginInfo;
begin
  try
    result := nil;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.TLoginInfo), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
function TServiceAdministracion_Proxy.ModificarFolioActual(const Campo: AnsiString; const Serie: AnsiString; const Folio: Integer): AnsiString;
begin
  try
...
function TServiceAdministracion_Proxy.ObtenerStatusCupon(const Barras: AnsiString): AnsiString;
begin
  try
...
function TServiceAdministracion_Proxy.ObtenerTipoCambioIDPorEstacion(const EstacionID: Integer): Integer;
begin
  try
...
function TServiceAdministracion_Proxy.ObtenerTipoCambioPorEstacion(const EstacionID: Integer): Double;
begin
  try
...
function TServiceAdministracion_Proxy.PrecioProducto(const EstacionID: Integer; const ProductoID: Integer): Double;
begin
  try
...
function TServiceAdministracion_Proxy.StatusTicket(const EstacionID: Integer; const TicketID: Integer): Integer;
begin
  try
...
function TServiceAdministracion_Proxy.SumaAnticipo(const Estacion: Integer; const Secuencia: Integer): Double;
begin
  try
...
function TServiceAdministracion_Proxy.SumaVentasCorte(const Estacion: Integer; const Secuencia: Integer; const AgrupacionID: Integer): Double;
begin
  try
...
function TServiceAdministracion_Proxy.ValoresTurno(const EstacionID: Integer; const TurnoID: Integer): TValoresTurno;
begin
  try
    result := nil;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.TValoresTurno), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
function TServiceAdministracion_Proxy.VersionServer: AnsiString;
begin
  try
...
function TServiceAdministracion_Proxy.LiquidacionCerrada(const EstacionID: Integer; const TurnoID: Integer): Boolean;
begin
  try
...
function TServiceAdministracion_Proxy.ClienteValido(const ClienteID: Integer; const NewClienteID: Integer): Boolean;
begin
  try
...
function TServiceAdministracion_Proxy.BuscaOtroProducto(const EstacionID: Integer; const Codigo: AnsiString): TOtroProducto;
begin
  try
    result := nil;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.TOtroProducto), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
function TServiceAdministracion_Proxy.TurnoALiquidacionID(const TurnoID: Integer; const EstacionID: Integer): Integer;
begin
  try
...
function TServiceAdministracion_Proxy.BuscaSagarpa(const EstacionID: Integer): TSagarpa;
begin
  try
    result := nil;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.TSagarpa), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
function TServiceAdministracion_Proxy.PuntosCalculaSaldo(const ClienteID: Integer): Double;
begin
  try
...
function TServiceAdministracion_Proxy.PuntosCalculaPuntos(const ClienteID: Integer; const ProductoID: Integer; const Volumen: Double): Double;
begin
  try
...
procedure TServiceAdministracion_Proxy.PuntosGuardaDatos(const Datos: TDatosPuntos);
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'PuntosGuardaDatos');
    __Message.Write('Datos', TypeInfo(LibraryAdministracion_Intf.TDatosPuntos), Datos, []);
    __Message.Finalize;
...
function TServiceAdministracion_Proxy.PuntosDatos(const ClienteID: Integer): TDatosPuntos;
begin
  try
    result := nil;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.TDatosPuntos), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
function TServiceAdministracion_Proxy.EliminaAutomaticosLiquidacion(const EstacionID: Integer; const TurnoID: Integer): Boolean;
begin
  try
...
function TServiceAdministracion_Proxy.BuscaDespachadorLiquidacion(const BombaID: Integer; const EstacionID: Integer; const TurnoID: Integer): Integer;
begin
  try
...
function TServiceAdministracion_Proxy.EntregaPremio(const ClienteID: Integer; const PremioID: Integer; const Cantidad: Integer): TEntregaPremio;
begin
  try
    result := nil;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.TEntregaPremio), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
function TServiceAdministracion_Proxy.DatosPremio(const PremioID: Integer): TDatosPremio;
begin
  try
    result := nil;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.TDatosPremio), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
function TServiceAdministracion_Proxy.ValidaConsumo(const Consumo: TConsumoExpress): Integer;
begin
  try
...
function TServiceAdministracion_Proxy.AgrupacionesBomba(const EstacionID: Integer): AAgrupacion;
begin
  try
    result := nil;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.AAgrupacion), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
function TServiceAdministracion_Proxy.DatosCerrarLiquidacion(const EstacionID: Integer; const TurnoID: Integer): TDatosCerrarLiquidacion;
begin
  try
    result := nil;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.TDatosCerrarLiquidacion), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
procedure TServiceAdministracion_Proxy.ProcesaVentasLiquidacion(const Datos: TDatosCerrarLiquidacion);
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'ProcesaVentasLiquidacion');
    __Message.Write('Datos', TypeInfo(LibraryAdministracion_Intf.TDatosCerrarLiquidacion), Datos, []);
    __Message.Finalize;
...
function TServiceAdministracion_Proxy.TicketsLiquidacion(const LiquidacionID: Integer): AnsiString;
begin
  try
...
function TServiceAdministracion_Proxy.ValidaFolioFactura(const Serie: AnsiString; const Folio: Integer): Boolean;
begin
  try
...
procedure TServiceAdministracion_Proxy.PuntosGuardaCriterios(const PuntosCriterioID: Integer; const Datos: AnsiString);
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'PuntosGuardaCriterios');
...
function TServiceAdministracion_Proxy.DatosFacturaElectronica(const FacturaID: Integer; const EstacionID: Integer): TFacturaElectronica;
begin
  try
    result := nil;
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'DatosFacturaElectronica');
    __Message.Write('FacturaID', TypeInfo(Integer), FacturaID, []);
    __Message.Write('EstacionID', TypeInfo(Integer), EstacionID, []);
    __Message.Finalize;
    ...
    __Message.Read('Result', TypeInfo(LibraryAdministracion_Intf.TFacturaElectronica), result, []);
  finally
    __Message.UnsetAttributes(__TransportChannel);
    __Message.FreeStream;
  end
...
function TServiceAdministracion_Proxy.LlavePrivaCertificado(const LlavePrivada: AnsiString; const Certificado: AnsiString; const GasolineroID: Integer; const Password: AnsiString; 
                                                            const EstacionID: Integer): AnsiString;
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'LlavePrivaCertificado');
...
function TServiceAdministracion_Proxy.SELLOPEMs(const Texto: Widestring; const EstacionID: Integer): AnsiString;
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'SELLOPEMs');
...
function TServiceAdministracion_Proxy.CERs(const DIR: AnsiString): AnsiString;
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'CERs');
...
function TServiceAdministracion_Proxy.ValidaLiquidacionDespachador(const LiquidacionID: Integer): AnsiString;
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'ValidaLiquidacionDespachador');
    __Message.Write('LiquidacionID', TypeInfo(Integer), LiquidacionID, []);
    __Message.Finalize;
...
function TServiceAdministracion_Proxy.ActualizaLiquidacionProd(const Estacion: Integer; const FechaIni: DateTime; const FechaFin: DateTime; const TurnoID: Integer): Boolean;
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'ActualizaLiquidacionProd');
    __Message.Write('Estacion', TypeInfo(Integer), Estacion, []);
...
procedure TServiceAdministracion_Proxy.PuntosDespachador(const TurnoID: Integer; const EstacionID: Integer; const UsuarioID: Integer);
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'PuntosDespachador');
    __Message.Write('TurnoID', TypeInfo(Integer), TurnoID, []);
    __Message.Write('EstacionID', TypeInfo(Integer), EstacionID, []);
    __Message.Write('UsuarioID', TypeInfo(Integer), UsuarioID, []);
    __Message.Finalize;
...
procedure TServiceAdministracion_Proxy.GuardarDatosFacturaPemex(const DatosFacturaPemex: TDatosFacturaPemex);
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'GuardarDatosFacturaPemex');
    __Message.Write('DatosFacturaPemex', TypeInfo(LibraryAdministracion_Intf.TDatosFacturaPemex), DatosFacturaPemex, []);
    __Message.Finalize;
...
function TServiceAdministracion_Proxy.AfectaInventarios(const LiquidacionID: Integer; const UsuarioID: Integer): AnsiString;
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'AfectaInventarios');
    __Message.Write('LiquidacionID', TypeInfo(Integer), LiquidacionID, []);
    __Message.Write('UsuarioID', TypeInfo(Integer), UsuarioID, []);
    __Message.Finalize;
...
procedure TServiceAdministracion_Proxy.InsertaFacturaElectronica(const FacturaElectronicaID: Integer; const CadenaOriginal: Widestring; const SelloDigital: Widestring; 
                                                                 const FacturaID: Integer; const Vigencia: Boolean; const Enviado: Boolean; const NoCertificado: AnsiString; 
                                                                 const NoAprobacion: AnsiString; const FechaAprobacion: DateTime);
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'InsertaFacturaElectronica');
...
function TServiceAdministracion_Proxy.CERsNUM(const DIR: AnsiString): AnsiString;
begin
  try
    __Message.InitializeRequestMessage(__TransportChannel, 'LibraryAdministracion', __InterfaceName, 'CERsNUM');
    __Message.Write('DIR', TypeInfo(AnsiString), DIR, []);
    __Message.Finalize;
...
initialization
  ...
  RegisterProxyClass(IServiceAdministracion_IID, TServiceAdministracion_Proxy);
...
finalization
  ...
  UnregisterProxyClass(IServiceAdministracion_IID);
